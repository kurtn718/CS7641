# All of the code in this file was obtained from:
# https://github.com/cmaron/CS-7641-assignments/blob/master/assignment1/experiments/plotting.py
#
# When we are told that we can steal the code from anywhere,
# using code for purely plotting graphs would seem fair game despite it
# having CS-7641-assignments as part of the Repository name.
#
# The data that goes into these graph functions, I would have to obtain via
# my analysis.
...
# Function adapted from above code
def plot_curve(title, X, Y, ylim=None,
                        x_scale='linear', y_scale='linear',
                        x_label='Parameter Varied', y_label='Accuracy (0.0 - 1.0)'):
    plt.close()
    plt.figure()
    plt.title(title)
    if ylim is not None:
